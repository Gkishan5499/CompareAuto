...
exports.seedStateTaxConfigs = void 0;
 ...
 */
const seedStateTaxConfigs = async () => {
    try {
        // Check if configs already exist
        const existingCount = await StateTaxConfig_model_1.default.countDocuments();
        if (existingCount > 0) {
            console.log(`State tax configs already exist (${existingCount} records). Skipping seed.`);
            return;
        }
        // Insert default configs
        await StateTaxConfig_model_1.default.insertMany(defaultStateTaxConfigs);
...
exports.seedStateTaxConfigs = seedStateTaxConfigs;
