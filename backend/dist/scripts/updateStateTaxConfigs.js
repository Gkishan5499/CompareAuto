...
exports.updateStateTaxConfigs = void 0;
...
const updateStateTaxConfigs = async () => {
    try {
        let updatedCount = 0;
        let notFoundStates = [];
...
exports.updateStateTaxConfigs = updateStateTaxConfigs;
...
if (require.main === module) {
    ...
    const run = async () => {
        try {
            ...
            await (0, exports.updateStateTaxConfigs)();
