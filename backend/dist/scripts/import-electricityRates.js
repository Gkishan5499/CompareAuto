...
const filePath = path_1.default.join(__dirname, "..", "data", "electricity-rates.json");
const importElectricityRates = async () => {
    try {
        ...
        await ElectricityRate_model_1.default.deleteMany();
        await ElectricityRate_model_1.default.insertMany(data);
