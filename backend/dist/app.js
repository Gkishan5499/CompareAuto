...
const heroCarousel_routes_1 = __importDefault(require("./routes/heroCarousel.routes"));
const enquiry_routes_1 = __importDefault(require("./routes/enquiry.routes"));
const comment_routes_1 = __importDefault(require("./routes/comment.routes"));
const siteSetting_routes_1 = __importDefault(require("./routes/siteSetting.routes"));
...
app.use("/api/hero-carousel", heroCarousel_routes_1.default);
app.use("/api/enquiries", enquiry_routes_1.default);
app.use("/api/comments", comment_routes_1.default);
app.use("/api/site-settings", siteSetting_routes_1.default);
