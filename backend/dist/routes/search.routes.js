...
router.get("/suggestions", async (req, res) => {
    try {
        ...
        for (const model of models) {
            ...
            const brandName = (brand === null || brand === void 0 ? void 0 : brand.name) || model.brandName || "";
            suggestions.push({
                type: "model",
                id: model.id,
                ...
                brandName: brandName,
                slug: model.slug,
                brandSlug: (brand === null || brand === void 0 ? void 0 : brand.slug) || brandName.toLowerCase().replace(/\s+/g, "-"),
                category: "Model",
